...
| `runtime`                          | `.cursor/rules/learned-runtime.mdc`                                      | `packages/runtime/**`, `packages/kernels/**`, `repos/opencascade.js/**`, `repos/replicad/**`, `repos/assimpjs/**`                                 | packages/runtime, defineKernel, defineTranscoder, RuntimeClient, transport, capabilities manifest, OCJS, replicad, opencascade, assimpjs, OCCT, WASM build |
...
| `openscad`                         | `.cursor/rules/learned-openscad.mdc`                                     | `packages/kernels/openscad/**`                                                                                                                    | packages/kernels/openscad, @taucad/openscad                                                                                                                |
