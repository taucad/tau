...
| `runtime`                          | `.cursor/rules/learned-runtime.mdc`                                      | `packages/runtime/**`, `packages/plugins/**`, `repos/opencascade.js/**`, `repos/replicad/**`, `repos/assimpjs/**`                                 | packages/runtime, packages/plugins, defineKernel, defineTranscoder, RuntimeClient, transport, capabilities manifest, OCJS, replicad, opencascade, assimpjs, OCCT, WASM build |
