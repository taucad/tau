...
| `runtime`                          | `.cursor/rules/learned-runtime.mdc`                                      | `packages/runtime/**`, `packages/plugins/**`, `repos/opencascade.js/**`, `repos/replicad/**`, `repos/libassimp/**`                                | packages/runtime, packages/plugins, defineKernel, defineTranscoder, RuntimeClient, transport, capabilities manifest, OCJS, replicad, opencascade, libassimp, OCCT, WASM build |
...
| `openrscad`                        | `.cursor/rules/learned-openrscad.mdc`                                    | `packages/plugins/openrscad/**`                                                                                                                   | packages/plugins/openrscad, @taucad/openrscad                                                                                                                                 |
...
| `deployment` (no Nx project)       | `.cursor/rules/learned-deployment.mdc`                                   | `repos/tau-cloud/**`, `apps/api/fly.*.toml`, `apps/ui/netlify.toml`, `apps/ui/server.ts`, `.github/workflows/**`, `infra/**`                      | fly.toml, netlify.toml, terraform, Cloudflare DNS, GitHub Actions, COOP/COEP                                                                                                  |
| `docs` (no Nx project)             | `.cursor/rules/learned-docs.mdc`                                         | `docs/**`, `apps/docs/content/docs/**`                                                                                                            | docs/policy, docs/research, docs/architecture, frontmatter, Fumadocs                                                                                                          |
