...
| `apps/libs/*`                | Private AGPL application capabilities; nothing under `packages/**` or `libs/**` may depend on them                                                                                                          |
...
| `apps/libs/telemetry`        | Private OTEL metric definitions, ingest schemas, and reporting contracts                                                                                                                                    |
