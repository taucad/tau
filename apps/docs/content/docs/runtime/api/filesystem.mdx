...
| `consumer`       | Surface                                                                                            |
| ---------------- | -------------------------------------------------------------------------------------------------- |
| `'working-copy'` | The checkout's own files, with no overlays composed above them. What the runtime reads and writes. |
| `'user'`         | What a person sees in the file tree: host-written records included, the control plane hidden.      |
| `'agent'`        | What an agent sees: records readable but not writable, the control plane hidden.                   |
