...
Python Build123d models do not pass through this bundler. The Build123d kernel uses bounded Python AST analysis for parameters and dependency discovery, then executes the mirrored project in its supervised native process.
