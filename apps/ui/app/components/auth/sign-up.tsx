...
import { Field, FieldDescription, FieldError, FieldGroup, FieldSeparator } from '@taucad/ui/components/field';
 ...
 */
export function SignUp({ className, socialLayout, socialPosition = 'bottom' }: SignUpProps): React.JSX.Element {
  const {
    additionalFields,
    authClient,
    basePaths,
