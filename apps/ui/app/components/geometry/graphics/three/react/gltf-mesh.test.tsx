...
import { markSectionSourceOnlyObject } from '#components/geometry/graphics/three/utils/section-source-only.js';
...
describe('model component BVH picking', () => {
  ...
  it('should collect only component-owned model surface meshes', () => {
    ...
    const sectionSourceOnlyMesh = buildRaycastMesh({ z: -3, componentId: firstComponentId });
    ...
    markSectionSourceOnlyObject(sectionSourceOnlyMesh);
    sectionHelperGroup.userData[sceneTag.sectionViewHelper] = true;
    sectionHelperGroup.add(sectionHelperMesh);
    scene.add(ownedMesh, ownerlessMesh, sectionSourceOnlyMesh, sectionHelperGroup, edgeLine);
