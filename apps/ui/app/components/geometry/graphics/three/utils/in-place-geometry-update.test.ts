    ...
    nodes: [
      {
        name: 'Part',
        primitives: [
          { mode: 4, positions, normals, indices: Uint32Array.from(indices), material },
...
describe('in-place geometry update', () => {
  ...
  it('should refuse a result whose materials changed', async () => {
    ...
    const recoloured = { ...surfaceMaterial, baseColorFactor: [1, 0, 0, 1] as [number, number, number, number] };
