 ...
 *
 * Used by the shared story as the "atoms" cloud that converges into the
 * design during loading and that the assembly disperses back into
 ...
 */
export function generateScatterPoints(pointCount: number, radius: number, random = Math.random): SampledPoints {
