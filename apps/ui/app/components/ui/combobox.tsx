  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        ...
        "w-full cursor-default py-1.5 pr-8 pl-2 text-sm data-highlighted:bg-menu-highlight data-highlighted:text-foreground data-highlighted:[&_svg:not([class*='text-'])]:text-foreground data-[disabled]:opacity-50 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        'flex min-h-9 flex-wrap items-center gap-1.5 rounded-md border border-input bg-transparent bg-clip-padding px-2.5 py-1.5 text-sm shadow-xs transition-[color,box-shadow] has-[[data-slot=combobox-chip-input]:focus-visible]:focus-outline has-aria-invalid:border-destructive has-data-[slot=combobox-chip]:px-1.5 dark:bg-input/30 dark:has-aria-invalid:border-destructive/50',
        className,
      )}
      {...props}
    />
...
function useComboboxAnchor(): React.RefObject<HTMLDivElement | undefined> {
  return React.useRef<HTMLDivElement | undefined>(undefined);
}
