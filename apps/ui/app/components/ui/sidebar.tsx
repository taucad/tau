  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {children}
          <div className='pointer-events-none absolute inset-y-0 right-0 z-30 w-4 border-r border-sidebar-border shadow-[inset_-12px_0_16px_-14px_rgb(0_0_0_/_0.14)] group-data-[variant=floating]:hidden' />
        </div>
      </div>
    </div>
  );
