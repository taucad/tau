  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          'relative grow overflow-hidden border rounded-full bg-muted data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5',
        )}
      >
