...
export function ChatMessageToolTransfer({ part }: { readonly part: ToolInvocationUIPart }) {
  ...
  return <p className="text-sm italic">Transferring to {sentenceCasedDestination}</p>;
}
