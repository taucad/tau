...
describe('PublicationFilesPane', () => {
  it('should render the Files header strip', () => {
    render(<PublicationFilesPane entryFile='main.ts' files={files} visibility='public' />);
  ...
  it('should mark the entry file with aria-current=page', () => {
    render(<PublicationFilesPane entryFile='main.ts' files={files} visibility='public' />);
  ...
  it('should fetch previews with session credentials for private publications', async () => {
    render(<PublicationFilesPane entryFile='main.ts' files={files} visibility='private' />);
