...
A [KernelPlugin](/docs/api/kernels) describes a CAD engine. Factory functions like `replicad()`, `openscad()`, `tscircuit()`, and `zoo()` return a registration object:
