---
title: Kernels
description: A multi-kernel CAD runtime for browser and Node.js. Run Replicad, OpenSCAD, JSCAD, Manifold, and Zoo from a unified API.
icon: lucide:blocks
---
...
| **Manifold (TSCircuit)** | TSX/JSX/TS/JS | Experimental electronics CAD flow (Circuit JSON -> GLTF). |
...
`@taucad/kernels` is the CAD runtime that powers [Tau](https://tau.new), the AI-powered CAD platform. The package is designed for standalone use -- you can integrate it into any JavaScript application without the Tau editor.
