---
title: Kernels
description: A multi-kernel CAD runtime for browser and Node.js. Run Replicad, OpenSCAD, JSCAD, TSCircuit, and Zoo from a unified API.
icon: lucide:blocks
---
...
| **TSCircuit** | TSX/JSX/TS/JS | Experimental electronics CAD flow (Circuit JSON -> GLTF). |
