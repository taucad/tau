...
related:
  ...
  - docs/research/moonshot-kimi-k3-langchain-blueprint.md
---
...
- Optional real-LLM: `apps/api/app/testing/moonshot-model.integration.test.ts` (reasoning, complete tool replay, cache accounting, and base64 vision)
