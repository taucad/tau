...
| Kernel (published)    | `packages/kernels/openscad`                                                                                                                                          | `GPL-2.0-or-later`   | Required — GPL text (bundles GPL WASM)                                                                   |
...
| Internal (private)    | `libs/{oxlint,vite,tau-examples}`, `scripts`, `tools/workspace-plugin`, `apps/runtime-e2e`, `apps/react-e2e/apps/*`, `examples/*`, the workspace root                | `Apache-2.0`         | Not required (never distributed)                                                                         |
