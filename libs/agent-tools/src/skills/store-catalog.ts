/**
 * The Tau Store skill catalog: compiled-in markdown, no loader.
 *
 * Pure data, so it travels with the resolver rather than with the app that
 * happened to author it first.
 *
 * @module
 */

/** One Tau Store skill and its shipped SKILL.md body. @public */
...
/** Every skill the Tau Store ships. @public */
