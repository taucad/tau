...
/**
 * Bundle manifold-3d type declarations into `declare module` blocks
 * for Monaco's `addExtraLib`.
 *
 ...
 * strips relative imports, and wraps them in `declare module` blocks.
 */
...
/**
 * Build the `declare module 'manifold-3d'` block by inlining:
 ...
 * live inside a single `declare module` block.
 */
...
/**
 * Build the `declare module 'manifold-3d/manifoldCAD'` block from
 * dist/manifoldCAD.d.ts, which is already self-contained (all types inline).
 */
