...
declare module 'manifold-3d/manifoldCAD' {
   ...
   * @group Global Settings
   */
  export const getAnimationFPS: () => number;
   ...
   * @group Global Settings
   */
  export const getCircularSegments: (radius: number) => number;
   ...
   */
  export const getGLTFNodes: () => GLTFNode[];
   ...
   * @group Global Settings
   */
  export const getMinCircularAngle: () => number;
   ...
   * @group Global Settings
   */
  export const getMinCircularEdgeLength: () => number;
   ...
   * @returns boolean
   */
  export function isManifoldCAD(): boolean
   ...
   */
  export const only: (manifold: Manifold) => Manifold;
   ...
   * effect.
   */
  export const resetGLTFNodes: () => void;
   ...
   */
  export const setMaterial: (manifold: Manifold, material: GLTFMaterial) => Manifold;
   ...
   */
  export const setMorphEnd: (manifold: Manifold, func: (v: Vec3) => void) => void;
   ...
   */
  export const setMorphStart: (manifold: Manifold, func: (v: Vec3) => void) => void;
   ...
   * @param manifold The object to show - returned for chaining.
   */
  export const show: (manifold: Manifold) => Manifold;
