// Bundled type declarations for libcascade package OpenCascadeInstance.
...
} from '../APIHeaderSection/index.js';
import {
  Adaptor2d_Curve2d,
  Adaptor2d_Line2d,
...
import {
  AppStd_Application,
} from '../AppStd/index.js';
import {
  AppStdL_Application,
} from '../AppStdL/index.js';
import {
  Approx_Curve2d,
  Approx_Curve3d,
...
} from '../BRepBlend/index.js';
import {
  BRepBndLib,
} from '../BRepBndLib/index.js';
import {
  BRepBuilderAPI,
...
} from '../BRepIntCurveSurface/index.js';
import {
  BRepLProp,
  BRepLProp_CLProps,
  BRepLProp_SLProps,
  BRepLProp_SurfaceTool,
} from '../BRepLProp/index.js';
import {
  BRepLib,
...
import {
  ElCLib,
} from '../ElCLib/index.js';
import {
  ElSLib,
} from '../ElSLib/index.js';
import {
  Expr,
  Expr_Absolute,
  Expr_ArcCosine,
...
import {
  ...
  FairCurve_Newton,
} from '../FairCurve/index.js';
import {
  FilletPoint,
} from '../FilletPoint/index.js';
import {
  FilletSurf_Builder,
...
import {
  ...
  Geom2dGcc_Type2,
  Geom2dGcc_Type3,
} from '../Geom2dGcc/index.js';
import {
  Geom2dHash_CurveHasher,
} from '../Geom2dHash/index.js';
import {
...
import {
  ...
  GeomLib_PolyFunc,
  GeomLib_Tool,
} from '../GeomLib/index.js';
import {
  GeomProjLib,
} from '../GeomProjLib/index.js';
import {
...
import {
  ...
  GeomToStep_Root,
} from '../GeomToStep/index.js';
import {
  GeomTools,
  GeomTools_Curve2dSet,
  GeomTools_CurveSet,
  GeomTools_SurfaceSet,
} from '../GeomTools/index.js';
import {
  HLRAlgo,
  HLRAlgo_BiPoint,
...
import {
  ...
  HelixGeom_Tools,
} from '../HelixGeom/index.js';
import {
  Hermit,
} from '../Hermit/index.js';
import {
...
import {
  ...
  MathOpt_UzawaConfig,
  MathOpt_UzawaResult,
} from '../MathOpt/index.js';
import {
  MathPoly_GeneralPolyResult,
} from '../MathPoly/index.js';
import {
  ...
  MathRoot_TrigResult,
} from '../MathRoot/index.js';
import {
  MathSys_LMConfig,
  MathSys_NewtonOptions,
} from '../MathSys/index.js';
import {
  MathUtils_Ackley,
  MathUtils_Beale,
  MathUtils_Booth,
...
} from '../MyDirectPolynomialRoots/index.js';
import {
...
import {
  PeriodicInterval,
} from '../PeriodicInterval/index.js';
import {
  PeriodicityInfo,
} from '../PeriodicityInfo/index.js';
import {
  Plate_D1,
  Plate_D2,
  Plate_D3,
...
import {
  PolygonOnTriHashKey,
} from '../PolygonOnTriHashKey/index.js';
import {
  Precision,
...
} from '../STEPSelections/index.js';
import {
  ShapeAlgo,
  ShapeAlgo_AlgoContainer,
  ShapeAlgo_ToolContainer,
} from '../ShapeAlgo/index.js';
import {
  ShapeAnalysis,
...
} from '../StepTidy/index.js';
import {
  StepToGeom,
} from '../StepToGeom/index.js';
import {
  StepToTopoDS,
...
} from '../TopBas/index.js';
import {
  TopCnx_EdgeFaceTransition,
} from '../TopCnx/index.js';
import {
  TopExp,
  TopExp_Explorer,
} from '../TopExp/index.js';
import {
  TopLoc_Datum3D,
  TopLoc_ItemLocation,
  TopLoc_Location,
...
} from '../decrementExceptionRefcount/index.js';
import {
  gce_ErrorType,
  gce_MakeCirc,
  gce_MakeCirc2d,
...
import {
  getExceptionMessage,
} from '../getExceptionMessage/index.js';
import {
  gp,
  gp_Ax1,
  gp_Ax2,
...
} from '../incrementExceptionRefcount/index.js';
import {
  math,
  math_BFGS,
  math_BissecNewton,
