...
type CanonicalScreenshotView = 'isometric' | 'front' | 'back' | 'right' | 'left' | 'top' | 'bottom';

describe('screenshot view contract', () => {
  it('should infer the canonical seven-value view union across tool and RPC results', () => {
