...
export const builtinExamples = [
  {
    locator: "jscad.cube",
    kernel: "jscad",
    manifest: {"$schema":"https://tau.new/schemas/tau-schema-v1.json","id":"proj_d90EiYaA9f14Rqn8D6ees","name":"JSCAD Cube","description":"The perfect starting point for your 3D modeling journey. This simple yet powerful cube demonstrates the fundamentals of parametric design with JSCAD. Adjust the size parameter to create anything from tiny components to large building blocks. Ideal for learning the basics or as a foundation for more complex geometric shapes.","tags":["3d-printing","parametric","jscad"],"assets":{"main":{"entryPath":"main.ts","thumbnail":"thumbnail.webp"}}},
  ...
  },
  {
    locator: "jscad.gear",
    kernel: "jscad",
    manifest: {"$schema":"https://tau.new/schemas/tau-schema-v1.json","id":"proj_kadVFdTACjJfWV77G4y85","name":"Involute Gear","description":"Design precision mechanical gears with mathematically accurate involute profiles. This advanced example showcases complex parametric modeling with customizable tooth count, pitch, pressure angle, and thickness. Perfect for creating functional gear systems, educational demonstrations, or replacement parts. Features optional center hole for shaft mounting and professional-grade gear geometry calculations.","tags":["3d-printing","parametric","jscad"],"assets":{"main":{"entryPath":"main.ts","thumbnail":"thumbnail.webp"}}},
  ...
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/openscad/kitchen-sink/thumbnail.webp") },
    ],
  },
  {
  ...
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/card-holder/thumbnail.webp") },
    ],
  },
  {
  ...
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/copper-lampshade/thumbnail.webp") },
    ],
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/cycloidal-gear/thumbnail.webp") },
    ],
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/decorated-box/thumbnail.webp") },
    ],
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/drinking-glass/thumbnail.webp") },
    ],
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/gridfinity-box/thumbnail.webp") },
    ],
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/hex-screwdriver/thumbnail.webp") },
    ],
  },
  {
  ...
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/planetary-gear-system/thumbnail.webp") },
    ],
  },
  {
  ...
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/simple-tray/thumbnail.webp") },
    ],
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/six-axis-arm/thumbnail.webp") },
    ],
  },
  {
  ...
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/t-slot-rail/thumbnail.webp") },
    ],
  },
  {
  ...
  },
  {
    ...
    assets: [
      ...
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/wedge-door-stopper/thumbnail.webp") },
    ],
  },
  {
    ...
    assets: [
      ...
      { path: "main.ts", load: loadTextAsset.bind(undefined, "./kernels/replicad/worm-gear-system/main.ts") },
      { path: "tau.json", load: loadTextAsset.bind(undefined, "./kernels/replicad/worm-gear-system/tau.json") },
      { path: "thumbnail.webp", load: loadBinaryAsset.bind(undefined, "./kernels/replicad/worm-gear-system/thumbnail.webp") },
      { path: "tooth-profile.ts", load: loadTextAsset.bind(undefined, "./kernels/replicad/worm-gear-system/tooth-profile.ts") },
    ],
  },
