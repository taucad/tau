...
describe('V8R2 CL-6 fit semantics', () => {
  ...
  it.skip('REQ-V8R2-065: residual T-FITS interfaces classify as running/press/contact (pump train, bushings, cam bearings)', async () => {
    await expectRequirementRelationships('REQ-V8R2-065');
  });

  it.skip('REQ-V8R2-066: piston skirt-to-bore clearance 0.020-0.050 (F03) at the gauge point, all 8', async () => {
    await expectRequirementRelationships('REQ-V8R2-066');
  });

  it.skip('REQ-V8R2-067: main bearing oil clearance 0.015-0.0325 radial (F04), all 5 mains', async () => {
    await expectRequirementRelationships('REQ-V8R2-067');
  });

  it.skip('REQ-V8R2-068: rod bearing oil clearance 0.0125-0.030 radial (F05), all 8 rods', async () => {
    await expectRequirementRelationships('REQ-V8R2-068');
  });

  it.skip('REQ-V8R2-069: cam bearing oil clearance 0.020-0.045 radial (F06), all 5 journals', async () => {
  ...
  it.skip('REQ-V8R2-071: rod pair side clearance bounded on every crankpin (F17 total 0.25-0.55)', async () => {
    await expectRequirementRelationships('REQ-V8R2-071');
  });

  it.skip('REQ-V8R2-072: lifter-to-bore clearance 0.010-0.030 (F07), all 16', async () => {
    await expectRequirementRelationships('REQ-V8R2-072');
  });

  it.skip('REQ-V8R2-073: stem-to-guide clearance IN 0.012-0.030 (F08) / EX 0.018-0.038 (F09), all 16 valves', async () => {
    await expectRequirementRelationships('REQ-V8R2-073');
  });

  it.skip('REQ-V8R2-074: damper hub pressed on the snout (P07) with the key contained in both keyways', async () => {
    await expectRequirementRelationships('REQ-V8R2-074');
  });

  it.skip('REQ-V8R2-075: flywheel spigot concentric and registered (F18); pilot bushing pressed (P10)', async () => {
    await expectRequirementRelationships('REQ-V8R2-075');
  });

  it.skip('REQ-V8R2-076: ring gear shrink 0.100-0.200 (P08) and reluctor press 0.030-0.060 (P09)', async () => {
  ...
  it.skip('REQ-V8R2-077: no unclassified positive-volume interference outside the declared P01-P16 allowances', async () => {
