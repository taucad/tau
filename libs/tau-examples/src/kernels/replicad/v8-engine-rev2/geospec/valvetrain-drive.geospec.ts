...
describe('V8R2 CL-4 valvetrain drive', () => {
  it.skip('REQ-V8R2-050: true cam lobe form (base circle Ø32) with cylinder-1 lifters on the base circle', async () => {
  ...
  it.skip('REQ-V8R2-051: all 16 lifter crowned feet contact their lobe at the modeled phase', async () => {
  ...
  it.skip('REQ-V8R2-055: cam thrust plate bolted to the block; endplay gaps inside the F16 band', async () => {
    await expectRequirementRelationships('REQ-V8R2-055');
  });

  it.skip('REQ-V8R2-056: 16 complete keeper/retainer stacks — beads in grooves, cones on retainers, steps on springs', async () => {
    await expectRequirementRelationships('REQ-V8R2-056');
  });

  it.skip('REQ-V8R2-057: true helical springs seated at installed height 40.0 +/-0.5, all 16', async () => {
    await expectRequirementRelationships('REQ-V8R2-057');
  });

  it.skip('REQ-V8R2-058: rockers pivot on stud-mounted balls, pallets on valve tips, studs engaged >= 20.0', async () => {
    await expectRequirementRelationships('REQ-V8R2-058');
  });

  it.skip('REQ-V8R2-059: 16 pushrods at full Ø9.5 with ball ends contained in lifter and rocker cups', async () => {
