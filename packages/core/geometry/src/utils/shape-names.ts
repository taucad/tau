/** Declares whether a caller-supplied name came from authored code or from generated/imported output. @public */
export type ShapeNameSource = 'authored' | 'generated' | 'external-generated';

/** Inputs for resolving an authored or fallback shape name. @public */
