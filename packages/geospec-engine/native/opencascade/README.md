# GeoSpec OpenCascade.js Native STEP Proofs

This directory contains the custom C++ STEP, BRep, and mesh wrappers
...
- `GeoSpecXdeReadResult` — retained structure + proof calls (`extrema`,
  ...
  subject-frame tessellation reporting the achieved deflection for canonical
  topological void proof)
- `_malloc`, `_free`
- `HEAP32`, `HEAPF64`, `FS`
