 ...
 * per-TU); see `geospecForensicEnabled` in the wrappers.
 */
...
export default defineBuild({
  ...
  customBindings: [
    {
      file: 'wrappers/geospec-mesh-metrics.cpp',
      symbols: ['GeoSpecPoint', 'GeoSpecMeshDistanceStats', 'GeoSpecMeshOverlapResult', 'GeoSpecMeshMetrics'],
    },
    {
  ...
  // worker_threads (GEOSPEC_WORKERS), not with pthreads inside one instance.
