...
Serializable mechanisms, pure forward kinematics, couplings, animation sampling and a damped least-squares pose solver

- Nx project: `kinematics`
- Project root: `packages/kinematics`
- Placement: `packages`
...
```bash
pnpm nx lint kinematics
pnpm nx test kinematics --watch=false
pnpm nx typecheck kinematics
pnpm nx build kinematics
pnpm nx pkgcheck kinematics
pnpm nx size kinematics
```
