...
import type { TranscoderPlugin } from '@taucad/runtime';
...
expectTypeOf<EdgeMap['stl']>().toEqualTypeOf<ExportOptionsFor<'stl'>>();
expectTypeOf<EdgeMap['obj']>().toEqualTypeOf<ExportOptionsFor<'obj'>>();
