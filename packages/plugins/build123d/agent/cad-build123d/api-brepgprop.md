...
// **init**(self
**init**(self: OCP.OCP.BRepGProp.BRepGProp) -> None
...
// **init**(*args, \*\*kwargs)
**init**(*args, \*\*kwargs)
**init**(self: OCP.OCP.BRepGProp.BRepGProp_Face, IsUseSpan: bool = False) -> None
**init**(self: OCP.OCP.BRepGProp.BRepGProp_Face, F: OCP.OCP.TopoDS.TopoDS_Face, IsUseSpan: bool = False) -> None
