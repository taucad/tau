...
// **init**(self
**init**(self: OCP.OCP.GeomConvert.GeomConvert) -> None
...
// **init**(*args, \*\*kwargs)
**init**(*args, \*\*kwargs)
**init**(self: OCP.OCP.GeomConvert.GeomConvert_BSplineCurveToBezierCurve, BasisCurve: OCP.OCP.Geom.Geom_BSplineCurve) -> None
**init**(self: OCP.OCP.GeomConvert.GeomConvert_BSplineCurveToBezierCurve, BasisCurve: OCP.OCP.Geom.Geom_BSplineCurve, U1: float, U2: float, ParametricTolerance: float) -> None
