...
// **init**(*args, \*\*kwargs)
**init**(*args, \*\*kwargs)
**init**(self: OCP.OCP.HLRAlgo.HLRAlgo_Projector) -> None
**init**(self: OCP.OCP.HLRAlgo.HLRAlgo_Projector, CS: OCP.OCP.gp.gp_Ax2) -> None
**init**(self: OCP.OCP.HLRAlgo.HLRAlgo_Projector, CS: OCP.OCP.gp.gp_Ax2, Focus: float) -> None
**init**(self: OCP.OCP.HLRAlgo.HLRAlgo_Projector, T: OCP.OCP.gp.gp_Trsf, Persp: bool, Focus: float) -> None
**init**(self: OCP.OCP.HLRAlgo.HLRAlgo_Projector, T: OCP.OCP.gp.gp_Trsf, Persp: bool, Focus: float, v1: OCP.OCP.gp.gp_Vec2d, v2: OCP.OCP.gp.gp_Vec2d, v3: OCP.OCP.gp.gp_Vec2d) -> None
