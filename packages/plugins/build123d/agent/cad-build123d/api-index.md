...
APIHeaderSection_MakeHeader.**init** (constructor) — **init**(\*args, \*\*kwargs)
...
NotAllLocationLikeError.**init** (constructor)
OrientedBoundBox (class) [13 members] — An Oriented Bounding Box
OrientedBoundBox.**init** (constructor) — Create an oriented bounding box from either a precomputed Bnd_OBB…
...
Plane.**init** (constructor) — Create a plane from either an OCCT gp_pln, Face, Location,…
...
BRepBndLib.**init** (constructor) — **init**(self
...
BRepBuilderAPI_MakeFace.**init** (constructor) — **init**(*args, \*\*kwargs)
...
BRepBuilderAPI_MakePolygon.**init** (constructor) — **init**(\*args, **kwargs)
...
BRepBuilderAPI_MakeSolid.**init** (constructor) — **init**(*args, **kwargs)
...
BRepBuilderAPI_Sewing.**init** (constructor) — **init**(self
...
BRepBuilderAPI_Transform.**init** (constructor) — **init**(\*args, \*\*kwargs)
...
BRepGProp.**init** (constructor) — **init**(self
...
BRepGProp_Face.**init** (constructor) — **init**(*args, \*\*kwargs)
...
BRepLib.**init** (constructor) — **init**(self
...
BRepMesh_IncrementalMesh.**init** (constructor) — **init**(*args, \*\*kwargs)
...
BRepTools.**init** (constructor) — **init**(self
...
BRepTools_WireExplorer.**init** (constructor) — **init**(*args, \*\*kwargs)
...
BRep_Builder.**init** (constructor) — **init**(self
...
BRep_Tool.**init** (constructor) — **init**(self
...
CylindricalJoint.**init** (constructor)
...
RevoluteJoint.**init** (constructor)
...
Bnd_OBB.**init** (constructor) — **init**(\*args, **kwargs)
...
GridLocations.**init** (constructor)
HexLocations (class) [1 members] — Location Context
HexLocations.**init** (constructor)
...
BytesIO.**init** (constructor) — Initialize self
...
ColorAndLabel.**init** (constructor)
...
Compound.**init** (constructor) — Build a Compound from Shapes
...
DraftAngleError.**init** (constructor)
Solid (class) [20 members] — A Solid in build123d represents a three-dimensional solid geometry
Solid.**init** (constructor) — Build a solid from an OCCT TopoDS_Shape/TopoDS_Solid
...
Edge.**init** (constructor) — Build an Edge from an OCCT TopoDS_Shape/TopoDS_Edge
...
Shell.**init** (constructor) — Build a shell from an OCCT TopoDS_Shape/TopoDS_Shell
...
FontManager.**init** (constructor) — Initialize FontManager
...
GProp_GProps.**init** (constructor) — **init**(\*args, \*\*kwargs)
...
GeomAPI_IntCS.**init** (constructor) — **init**(*args, \*\*kwargs)
...
GeomAPI_IntSS.**init** (constructor) — **init**(\*args, **kwargs)
...
GeomAPI_ProjectPointOnSurf.**init** (constructor) — **init**(*args, **kwargs)
...
GeomConvert.**init** (constructor) — **init**(self
...
GeomConvert_BSplineCurveToBezierCurve.**init** (constructor) — **init**(*args, \*\*kwargs)
...
Geom_BSplineCurve.**init** (constructor) — **init**(*args, \*\*kwargs)
...
Geom_BezierCurve.**init** (constructor) — **init**(*args, **kwargs)
...
Geom_BoundedSurface.**init** (constructor) — Initialize self
...
Geom_ElementarySurface.**init** (constructor) — Initialize self
...
Geom_Line.**init** (constructor) — **init**(*args, \*\*kwargs)
...
Geom_Plane.**init** (constructor) — **init**(*args, \*\*kwargs)
...
HLRAlgo_Projector.**init** (constructor) — **init**(*args, \*\*kwargs)
...
HLRBRep_Algo.**init** (constructor) — **init**(*args, \*\*kwargs)
...
HLRBRep_HLRToShape.**init** (constructor) — **init**(self
...
IFSelect_ReturnStatus.**init** (constructor) — **init**(self
...
IGESControl_Controller.**init** (constructor) — **init**(self
...
Interface_Static.**init** (constructor) — **init**(*args, \*\*kwargs)
...
Message.**init** (constructor) — **init**(self
...
Message_Gravity.**init** (constructor) — **init**(self
...
Message_ProgressRange.**init** (constructor) — **init**(*args, **kwargs)
...
Quantity_Color.**init** (constructor) — **init**(*args, \*\*kwargs)
...
Quantity_ColorRGBA.**init** (constructor) — **init**(*args, \*\*kwargs)
...
Quantity_TypeOfColor.**init** (constructor) — **init**(self
...
RWGltf_CafWriter.**init** (constructor) — **init**(self
...
RWStl.**init** (constructor) — **init**(self
...
STEPCAFControl_Controller.**init** (constructor) — **init**(self
...
STEPCAFControl_Reader.**init** (constructor) — **init**(*args, \*\*kwargs)
...
STEPCAFControl_Writer.**init** (constructor) — **init**(*args, **kwargs)
...
STEPControl_Controller.**init** (constructor) — **init**(self
...
STEPControl_StepModelType.**init** (constructor) — **init**(self
...
StlAPI_Writer.**init** (constructor) — **init**(self
...
TColStd_IndexedDataMapOfStringString.**init** (constructor) — **init**(*args, \*\*kwargs)
...
TCollection_AsciiString.**init** (constructor) — **init**(*args, \*\*kwargs)
...
TCollection_ExtendedString.**init** (constructor) — **init**(*args, **kwargs)
...
TCollection_HAsciiString.**init** (constructor) — **init**(*args, \*\*kwargs)
...
TDF_Label.**init** (constructor) — **init**(self
...
TDF_LabelSequence.**init** (constructor) — **init**(\*args, **kwargs)
...
TDataStd_Name.**init** (constructor) — **init**(self
...
TDocStd_Document.**init** (constructor) — **init**(self
...
TopAbs_Orientation.**init** (constructor) — **init**(self
...
TopAbs_ShapeEnum.**init** (constructor) — **init**(self
...
TopExp_Explorer.**init** (constructor) — **init**(\*args, \*\*kwargs)
...
TopLoc_Location.**init** (constructor) — **init**(*args, \*\*kwargs)
...
XCAFApp_Application.**init** (constructor) — Initialize self
...
XCAFDoc_ColorTool.**init** (constructor) — **init**(self
...
XCAFDoc_ColorType.**init** (constructor) — **init**(self
...
XCAFDoc_DocumentTool.**init** (constructor) — **init**(self
...
XCAFDoc_ShapeTool.**init** (constructor) — **init**(self
...
XSControl_WorkSession.**init** (constructor) — **init**(self
...
gp_Ax1.**init** (constructor) — **init**(*args, \*\*kwargs)
...
gp_Ax2.**init** (constructor) — **init**(\*args, **kwargs)
...
gp_Ax3.**init** (constructor) — **init**(*args, **kwargs)
...
gp_Dir.**init** (constructor) — **init**(*args, \*\*kwargs)
...
gp_EulerSequence.**init** (constructor) — **init**(self
...
gp_GTrsf.**init** (constructor) — **init**(*args, \*\*kwargs)
...
gp_Lin.**init** (constructor) — **init**(*args, \*\*kwargs)
...
gp_Pln.**init** (constructor) — **init**(\*args, **kwargs)
...
gp_Pnt.**init** (constructor) — **init**(\*args, **kwargs)
...
gp_Quaternion.**init** (constructor) — **init**(*args, **kwargs)
...
gp_Trsf.**init** (constructor) — **init**(*args, \*\*kwargs)
...
gp_Vec.**init** (constructor) — **init**(\*args, **kwargs)
...
gp_XYZ.**init** (constructor) — **init**(*args, **kwargs)
