...
// **init**(*args, \*\*kwargs)
**init**(*args, \*\*kwargs)
**init**(self: OCP.OCP.Interface.Interface_Static, family: str, name: str, type: OCP.OCP.Interface.Interface_ParamType = <Interface_ParamType.Interface_ParamText: 5>, init: str = '') -> None
**init**(self: OCP.OCP.Interface.Interface_Static, family: str, name: str, other: OCP.OCP.Interface.Interface_Static) -> None
