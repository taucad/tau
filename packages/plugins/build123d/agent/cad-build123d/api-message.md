...
// **init**(self
**init**(self: OCP.OCP.Message.Message) -> None
...
// **init**(self
**init**(self: OCP.OCP.Message.Message_Gravity, value: int) -> None
...
// **init**(*args, \*\*kwargs)
**init**(*args, \*\*kwargs)
**init**(self: OCP.OCP.Message.Message_ProgressRange) -> None
**init**(self: OCP.OCP.Message.Message_ProgressRange, theOther: OCP.OCP.Message.Message_ProgressRange) -> None
