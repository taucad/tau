...
// **init**(self
**init**(self: OCP.OCP.TDF.TDF_Label) -> None
...
// **init**(*args, \*\*kwargs)
**init**(*args, \*\*kwargs)
**init**(self: OCP.OCP.TDF.TDF_LabelSequence) -> None
**init**(self: OCP.OCP.TDF.TDF_LabelSequence, theAllocator: OCP.OCP.NCollection.NCollection_BaseAllocator) -> None
**init**(self: OCP.OCP.TDF.TDF_LabelSequence, theOther: OCP.OCP.TDF.TDF_LabelSequence) -> None
