...
// **init**(*args, \*\*kwargs)
**init**(*args, \*\*kwargs)
**init**(self: OCP.OCP.TopLoc.TopLoc_Location) -> None
**init**(self: OCP.OCP.TopLoc.TopLoc_Location, T: OCP.OCP.gp.gp_Trsf) -> None
**init**(self: OCP.OCP.TopLoc.TopLoc_Location, D: OCP.OCP.TopLoc.TopLoc_Datum3D) -> None
