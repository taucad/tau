...
// **init**(self
**init**(self: OCP.OCP.TopoDS.TopoDS_Compound) -> None
...
// **init**(self
**init**(self: OCP.OCP.TopoDS.TopoDS_Edge) -> None
...
// **init**(self
**init**(self: OCP.OCP.TopoDS.TopoDS_Face) -> None
...
// **init**(self
**init**(self: OCP.OCP.TopoDS.TopoDS_Shape) -> None
...
// **init**(self
**init**(self: OCP.OCP.TopoDS.TopoDS_Vertex) -> None
...
// **init**(self
**init**(self: OCP.OCP.TopoDS.TopoDS_Wire) -> None
