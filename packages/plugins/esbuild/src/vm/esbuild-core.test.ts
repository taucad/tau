...
import { createVfsPlugin, extractProjectDependencies, extractExternalImports } from '#vm/esbuild-core.js';
import { esbuildNamespace, httpFetchMaxSizeBytes } from '#vm/esbuild.constants.js';
import { ModuleManager } from '#vm/module-manager.js';
// oxlint-disable-next-line no-restricted-imports, import/extensions -- White-box test fixture stays outside the package build graph.
import { createMockFileSystem, createMockResponse } from '../../test/support/vm-test-utils.js';
// oxlint-disable-next-line no-restricted-imports, import/extensions -- White-box test fixture stays outside the package build graph.
import type { MockFileSystem } from '../../test/support/vm-test-utils.js';
