...
public static Vector3 operator _(Vector3 left, Vector3 right)
public static Vector3 operator _(Vector3 left, float right)
...
public static Vector4 operator _(Vector4 left, Vector4 right)
public static Vector4 operator _(Vector4 left, float right)
