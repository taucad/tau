 ...
 *
 * Run with: pnpm nx wasm-inspect replicad
 *   Options:
 ...
 *     --output <path>     Directory for output reports (default: ../../../out/reports/wasm-inspect/replicad)
...
const { values } = parseArgs({
  options: {
    ...
    output: { type: 'string', short: 'o', default: '../../../out/reports/wasm-inspect/replicad' },
...
Usage:
  pnpm nx wasm-inspect replicad [-- options]

Options:
  -w, --wasm <path>      WASM file (default: auto-detect replicad_single.wasm)
  -s, --symbols <path>   Symbol map generated by --emit-symbol-map
  -o, --output <dir>     Output directory
                         (default: ../../../out/reports/wasm-inspect/replicad)
...
const defaultWasmPath = createRequire(new URL('../package.json', import.meta.url)).resolve(
...
function findWasmFile(): string {
  ...
  const candidates = [defaultWasmPath, join(symbolsDirectory, 'dist/replicad_single.wasm')];
