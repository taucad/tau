 ...
 */
export class ThreeDmLoader extends ImportLoader<Document> {
  private readonly rhino: RhinoModule;
  ...
  public constructor(rhino: RhinoModule) {
    super();
    this.rhino = rhino;
  }

  protected async parse(files: readonly ImportFile[]): Promise<Document> {
