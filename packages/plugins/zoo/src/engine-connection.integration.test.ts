...
/* oxlint-disable @typescript-eslint/no-extraneous-class -- WASM API constructor test doubles */
/* oxlint-disable no-await-in-loop -- session lifecycle assertions are intentionally sequential */
