...
/* oxlint-disable no-await-in-loop -- reconnect lifecycle assertions are intentionally sequential */
...
import type { ZooFakeWebSocket } from '#testing/zoo-fake-websocket.js';
