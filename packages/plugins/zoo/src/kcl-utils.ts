...
import { EngineConnection, MockEngineConnection } from '#engine-connection.js';
...
import type { KclSceneGraphDelta } from '#kcl-scene-graph-delta.js';

import type { KclExecutionResult } from '#kcl-execution-result.types.js';
import { buildKclSettingsJson } from '#kcl-headless-settings.js';

/**
 * URL to the KCL WASM binary exposed by the dependency package.
 *
 * @see https://web.dev/articles/bundling-non-js-resources#universal_pattern_for_browsers_and_bundlers
 */
export const kclWasmUrl = new URL(import.meta.resolve('@taucad/kcl-wasm-lib/kcl.wasm')).href;
