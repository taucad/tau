 ...
 *
 * Usage:
 *   pnpm nx benchmark-replicad-tessellation runtime -- \
...
const { values, positionals } = parseArgs({
  options: {
    ...
    output: { type: 'string', short: 'o', default: 'reports/replicad-tessellation' },
...
Usage:
  pnpm nx benchmark-replicad-tessellation runtime -- --fixture <project.zip> [--fixture <project.zip>]
...
const wasmDirectory = resolve(packageRoot, 'src/kernels/replicad/wasm');
