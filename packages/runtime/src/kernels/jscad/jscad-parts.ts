...
function isJscadGeometry(value: unknown): boolean {
 ...
 */
export function isRenderableJscadPart(part: JscadPartDescriptor): boolean {
  return geometries.geom3.isA(part.shape);
}
 ...
 */
export function normalizeJscadParts(value: unknown): JscadPartDescriptor[] {
 ...
 */
export function getRenderableJscadParts(value: unknown): JscadPartDescriptor[] {
  return normalizeJscadParts(value).filter((part) => isRenderableJscadPart(part));
}
