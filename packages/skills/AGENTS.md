...
Tau CAD agent skill bundles, aggregated for any agent host

- Nx project: `skills`
- Project root: `packages/skills`
- Placement: `packages`
...
```bash
pnpm nx lint skills
pnpm nx test skills --watch=false
pnpm nx typecheck skills
pnpm nx build skills
pnpm nx pkgcheck skills
pnpm nx size skills
```
