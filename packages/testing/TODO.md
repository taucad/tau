...
- [ ] `toBeWatertight()`
- [x] `toHaveNoComponentInterference({ tolerance, pairs, allowances })`
  - Chosen first-class assembly-interference API.
...
- [ ] Selector-aware exact interference API for a future slice.
  - Do not add a duplicate alias for the P0 whole-assembly invariant. Use `toHaveNoComponentInterference({ tolerance, pairs, allowances })` today.
