...
import { infiniteGridMaterial } from '#materials/infinite-grid-material.js';
import type { InfiniteGridMaterialProperties } from '#materials/infinite-grid-material.js';
