 ...
 *
 * @param options - Axis rotation options.
 * @param options.axis - The axis to rotate around (should be normalized)
 * @param options.position - The position of the object in world space
 * @param options.camera - The camera to face towards
 * @param options.referenceUp - Optional reference "up" vector perpendicular to the axis (default: best perpendicular to axis)
...
export function computeAxisRotationForCamera(options: {
  ...
  const { axis, position, camera, referenceUp } = options;
