...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'flex h-7 shrink-0 items-center rounded-md px-2 text-sm font-medium whitespace-nowrap text-muted-foreground/55 outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:focus-outline [&>svg]:size-4 [&>svg]:shrink-0',
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'absolute top-1/2 right-3 flex aspect-square w-5 -translate-y-1/2 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden transition-transform focus-visible:focus-outline [&>svg]:size-4 [&>svg]:shrink-0',
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md py-2 text-left text-sm outline-hidden transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:focus-outline active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:text-foreground data-[state=open]:hover:bg-sidebar-accent group-data-[collapsible=icon]:size-7! px-1.5 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      variant: {
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        nestedActionVariants(),
        'absolute top-1/2 right-1 flex aspect-square w-5 -translate-y-1/2 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden transition-transform peer-hover/menu-button:text-sidebar-accent-foreground focus-visible:focus-outline [&>svg]:size-4 [&>svg]:shrink-0',
        // Increases the hit area of the button on mobile.
        'after:absolute after:-inset-2 md:after:hidden',
        'group-data-[collapsible=icon]:hidden',
        shouldShowOnHover &&
