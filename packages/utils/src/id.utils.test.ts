...
describe('id.utils', () => {
  describe('generatePrefixedId', () => {
    ...
    it('should generate an ID with the wsp prefix for workspace IDs', () => {
      const id = generatePrefixedId(idPrefix.workspace);
      expect(id).toMatch(/^wsp_[\dA-Za-z]{21}$/);
    });
  ...
  describe('validatePrefixedId', () => {
    it('should not throw for valid prefixed IDs', () => {
      ...
      expect(() => {
        validatePrefixedId('wsp_workspace01');
      }).not.toThrow();
    });
  ...
  describe('extractPrefix', () => {
    it('should extract the prefix from a valid ID', () => {
      ...
      expect(extractPrefix('wsp_workspace01')).toBe('wsp');
    });
